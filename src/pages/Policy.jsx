...
function Policy() {
  return (
    <Container>
        ...
        <p className="text-gray-600">Effective Date: [22/02/2024]</p>
        </div>
        <section className="py-8 px-14">
            <h2 className="text-2xl font-bold text-gray-800">1. Information We Collect:</h2><br/>
            
            <h3 className="text-xl font-bold text-gray-700">1.1. Personal Information:</h3>
            ...
            <h3 className="text-xl font-bold text-gray-700">1.2. Usage Data:</h3>
        ...
        <section className="py-8 px-14">
        <h2 className="text-2xl font-bold text-gray-800">2. How We Use Your Information:</h2><br/>
        
        <h3 className="pl-18 text-xl font-bold text-gray-700">2.1. Personalization:</h3>
        ...
        <h3 className="pl-18 text-xl font-bold text-gray-700">2.2. Communication:</h3>
        ...
        <h3 className="pl-18 text-xl font-bold text-gray-700">2.3. Analytics:</h3>
        ...
        <section className="py-8 px-14">
        <h2 className="text-2xl font-bold text-gray-800">3. Information Sharing:</h2><br/>
        
        <h3 className="pl-18 text-xl font-bold text-gray-700">3.1. Third-Party Services:</h3>
        ...
        <h3 className="pl-18 text-xl font-bold text-gray-700">3.2. Legal Compliance:</h3>
    ...
    <section className="py-8 px-14">
        <h2 className="text-2xl font-bold text-gray-800">4. Your Choices:</h2><br/>
        
        <h3 className="pl-18 text-xl font-bold text-gray-700">4.1. Account Settings:</h3>
        ...
        <h3 className="pl-18 text-xl font-bold text-gray-700">4.2. Opting Out:</h3>
    ...
    <section className="py-8 px-14">
        <h2 className="pl-18 text-2xl font-bold text-gray-800">5. Security:</h2><br/>
    ...
    <section className="py-8 px-14">
        <h2 className="pl-18 text-2xl font-bold text-gray-800">6. Children's Privacy:</h2><br/>
...
are a parent or guardian and believe that your child has provided us with personal information, please contact us.</p><br/>
    ...
    <section className="py-8 px-14">
        <h2 className="pl-18 text-2xl font-bold text-gray-800">7. Changes to this Privacy Policy:</h2><br/>
    ...
    <section className="py-8 px-14">
        <h2 className="pl-18 text-2xl font-bold text-gray-800">8. Contact Us:</h2><br/>
