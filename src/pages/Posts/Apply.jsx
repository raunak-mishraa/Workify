    ...
    <section>
      <Container>
        <div className='font-poppins mb-10 space-y-4'>
          ...
          <Button onClick={() =>handleApply()} className={`${!loading ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white' : 'bg-white text-gray-900'} p-3  rounded-lg border border-gray-200 sm:w-1/5 w-full`}>{loading && 
