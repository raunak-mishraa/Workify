        ...
        <section className='py-10 sm:py-20 font-[assistant]'>
            ...
            <div>
                ...
                {categories.map((category, index) => (
                    <Link to={`/gigs?category=${category.name}`} key={index} className='opacity-90 p-6 py-10 rounded-lg bg-slate-50 shadow-md flex flex-col gap-3 hover:bg-slate-100 duration-200 ease-in'>
