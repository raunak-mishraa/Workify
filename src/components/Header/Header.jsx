...
import { Logo, Navlinks, Button }from '../index'
function Header() {
        ...
        <Container>
          <nav>
            <div className='flex items-center justify-between h-20'>
              ...
              {/* mobile view */}
              <ul className={` md:hidden bg-white z-10 absolute w-full h-full bottom-0 py-20 px-6 duration-500 ${open ? 'left-0' : 'left-[-100%]'}`}>
